...
//             }
//
//             if ((dbHeaders.ChunksCount * dbHeaders.Height) % dbHeaders.ChunkSize != 0)
//             {
//                 throw new InvalidOperationException();
//             }
//
//             if ((DbHeaders.BinaryLength + dbHeaders.ChunksCount * dbHeaders.Height + dbHeaders.ChunksCount * dbHeaders.Height /
//                     dbHeaders.ChunkSize * ChunkMetadataSize) != dbStream.Length)
//             {
//                 throw new InvalidOperationException();
//             }
//
//             wal = await WAL.OpenOrCreateAsync(GetWalFileName(path), dbHeaders.LastAppliedWalIndex);
//
//
//             memoryMappedFile = MemoryMappedFile.CreateFromFile(dbStream, null, 0, MemoryMappedFileAccess.ReadWrite,
//                 HandleInheritability.None, true);
